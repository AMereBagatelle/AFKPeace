...
public class DisconnectRetryScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(var10003, Math.min(var10004 + 9, this.height - 30), 200, 20, new TranslatableText("gui.toMenu"), (buttonWidget) -> this.client.openScreen(this.parent)));
        // Attempts to reconnect to the server you got disconnected from
        this.addButton(new ButtonWidget(var10003, Math.min(var10004 + 9, this.height - 30) + 20, 200, 20, new LiteralText("Reconnect"), (buttonWidget) -> AFKPeace.connectUtil.connectToServer(serverInfo)));
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.method_27534(matrices, var10002, this.title, var10004, var10005 - 9 * 2, 11184810);
